...
const Gauge: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m12 14 4-4" /><path d="M3.34 19a10 10 0 1 1 17.32 0" /></svg>
);
const ScanLine: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 7V5a2 2 0 0 1 2-2h2" /><path d="M17 3h2a2 2 0 0 1 2 2v2" /><path d="M21 17v2a2 2 0 0 1-2 2h-2" /><path d="M7 21H5a2 2 0 0 1-2-2v-2" /><path d="M7 12h10" /></svg>
);
...
const ITEMS: FeatureItem[] = [
  ...
  { key: 'evac', Icon: Users },
  { key: 'aset', Icon: Gauge },
  { key: 'recognition', Icon: ScanLine },
  { key: 'mcp', Icon: MessageSquare },
...
const FeaturesSection: React.FC = () => {
  ...
  return (
    <section id="features" className="bulc-features">
      <div className="bulc-features__container">
        <div className="bulc-features__header">
          <div className="bulc-features__eyebrow">{t('bulc.features.eyebrow')}</div>
          <h2 className="bulc-features__title">{t('bulc.features.title')}</h2>
          <p className="bulc-features__subtitle">{t('bulc.features.subtitle')}</p>
        </div>

        <div className="bulc-features__grid">
          {ITEMS.map(({ key, Icon }) => (
            <div key={key} className="bulc-features__card">
              <span className="bulc-features__card-icon">
                <Icon className="bulc-features__card-icon-svg" />
              </span>
              <h3 className="bulc-features__card-title">{t(`bulc.features.items.${key}.title`)}</h3>
              <p className="bulc-features__card-desc">{t(`bulc.features.items.${key}.desc`)}</p>
            </div>
          ))}
        </div>
      </div>
