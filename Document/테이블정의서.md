...
| extra_meta    | TEXT         | N  | 추가 메타 정보 (내부 메모, 태그 등, JSON 형식)      |
| created_at    | TIMESTAMP    | Y  | 생성 시각                                   |
| updated_at    | TIMESTAMP    | Y  | 수정 시각                                   |
...
| raw_profile     | TEXT         | N  | provider에서 받은 원본 프로필 (JSON 형식)                                     |
| created_at      | TIMESTAMP    | Y  | 생성 시각                                                                   |
| updated_at      | TIMESTAMP    | Y  | 수정 시각                                                                   |
...
| metadata   | TEXT           | N    | 라이선스 수량, 좌석 수 등 확장 정보 (JSON 형식) |
| created_at | TIMESTAMP      | Y    | 생성 시각                                 |
...
| raw_response      | TEXT           | N    | PG에서 받은 원본 응답 (JSON 형식)                                          |
| created_at        | TIMESTAMP      | Y    | 생성 시각                                                               |
| updated_at        | TIMESTAMP      | Y    | 수정 시각                                                               |
...
| raw_response   | TEXT           | N    | PG 환불 응답 원본 (JSON 형식)                          |
| created_at     | TIMESTAMP      | Y    | 생성 시각                                            |
| updated_at     | TIMESTAMP      | Y    | 수정 시각                                            |
...
| metadata    | TEXT           | N    | 버튼 ID, 상품 ID, 에러 내용 등 상세 정보 (JSON 형식)                           |
